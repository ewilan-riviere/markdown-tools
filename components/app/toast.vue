...
<template>
  ...
  >
    <span
      class="absolute inset-x-0 bottom-0 h-1 bg-purple-600 animate-life"
    ></span>
    <div class="p-4">
      <div class="flex items-start">
        ...
        <div class="ml-4 flex shrink-0">
          <button
            class="inline-flex rounded-md text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 dark:bg-gray-800 dark:text-gray-300"
            @click="clear"
          >
