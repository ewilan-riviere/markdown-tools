<footer class="main-container pt-12 pb-8">
    <div class="md:flex md:items-center md:justify-between">
        <div class="flex justify-center space-x-6 md:order-2">
            <a href="https://github.com/ewilan-riviere/markdown-interpreter" target="_blank" rel="noopener noreferrer"
        ...
        <div class="mt-8 md:mt-0 md:order-1">
            <p class="text-center text-base text-gray-400 md:flex md:items-center">
                ...
                {{ $licence_year }}<span class="mx-1">·</span><a href="https://github.com/ewilan-riviere"
                    ...
                    class="mr-1">.</span><a
                    href="https://gitlab.com/ewilan-riviere/markdown-interpreter/-/blob/main/LICENSE" target="_blank"
