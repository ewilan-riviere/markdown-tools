...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function models($modelsPath, $outputPath)
        {
                        return \Kiwilan\Typescriptable\Typescriptable::models($modelsPath, $outputPath);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function routes($routeList, $outputPath)
        {
                        return \Kiwilan\Typescriptable\Typescriptable::routes($routeList, $outputPath);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function settings($settingsPath, $outputPath, $extends)
        {
                        return \Kiwilan\Typescriptable\Typescriptable::settings($settingsPath, $outputPath, $extends);
        }
...
namespace  { 
            ...
            class Typescriptable extends \Kiwilan\Typescriptable\Facades\Typescriptable {}
